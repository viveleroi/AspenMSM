	...
	<div id="editor_<?php print $next_id ?>_form" class="editable">
		...
		<ol>
			<li
				...
				<a class="help" href="<?php print router()->moduleUrl('Contacts_Admin') ?>/help/section-contactgroup-subtitle.htm" title="Sub-Title">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Contacts_Admin') ?>/help/section-contactgroup-show_subtitle.htm" title="Show Sub-Title">Help</a>
			</li>
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('Contacts_Admin') ?>/help/section-contactgroup-placement_group.htm" title="Placement Group">Help</a>
			</li>
			<li class="auto">
			...
			<li class="auto">
				...
				<?php print template()->optionArray( template()->selectArray('contacts', 'last_name', 'DISTINCT', 'last_name'), $section['content']['contact_id'], true); ?>
				</select>
