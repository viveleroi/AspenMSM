	...
	<?= sml()->printMessage(); ?>
	<div class="frame">
		<h3 class="show-hide"><a id="current" class="toggle-frame open" href="#" title="Click to Open/Close this Section">Hide</a> Upcoming Events (<?php print count($cur_events); ?>)</h3>
			...
			<ul id="current-list" class="list-display">
				...
				<li id="item_<?php print $events_item['id'] ?>_listing">
					<div class="legend">
						...
						<strong><?php print DataDisplay::truncateText($events_item['title'], 5); ?></strong>
						<span class="icons">
		...
		<div class="frame">
		<h3 class="show-hide"><a id="recurring" class="toggle-frame open" href="#" title="Click to Open/Close this Section">Hide</a> Recurring Events (<?php print count($recurring_events); ?>)</h3>
	...
	<div class="frame">
		<h3 class="show-hide"><a id="past" class="toggle-frame" href="#" title="Click to Open/Close this Section">Hide</a> Past Events (<?php print count($past_events); ?>)</h3>
