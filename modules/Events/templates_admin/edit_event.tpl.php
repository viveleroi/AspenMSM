	...
	<form action="<?php print $this->createFormAction() ?>" method="post">
		<div class="frame">
			<h3>Event Details</h3>
			<fieldset>
				<input type="hidden" name="id" id="event_id" value="<?php print $values['id'] ?>" />
				<ol>
					<li class="full">
				...
				<ol>
					<li class="half auto">
						...
						for($h = 1; $h <= 12; $h++){
						?>
							<option<?php print ($values['start_hour'] == $h ? ' selected="selected"' : '') ?>><?php print $h ?></option>
						<?php
						}
						?>
						</select>
						...
						<select id="start_minute" name="start_minute" class="tight">
							<option value="">--</option>
							<option<?php print ($values['start_minute'] == '00' ? ' selected="selected"' : '') ?>>00</option>
							<option<?php print ($values['start_minute'] == '15' ? ' selected="selected"' : '') ?>>15</option>
							<option<?php print ($values['start_minute'] == '30' ? ' selected="selected"' : '') ?>>30</option>
							<option<?php print ($values['start_minute'] == '45' ? ' selected="selected"' : '') ?>>45</option>
						</select>
						<select id="start_ampm" name="start_ampm">
							<option value="">--</option>
							<option<?php print ($values['start_ampm'] == 'am' ? ' selected="selected"' : '') ?>>am</option>
							<option<?php print ($values['start_ampm'] == 'pm' ? ' selected="selected"' : '') ?>>pm</option>
						</select>
					...
					<li class="half auto">
						...
						for($h = 1; $h <= 12; $h++){
						?>
							<option<?php print ($values['end_hour'] == $h ? ' selected="selected"' : '') ?>><?php print $h ?></option>
						<?php
						}
						?>
						</select>
						...
						<select id="end_minute" name="end_minute" class="tight">
							<option value="">--</option>
							<option<?php print ($values['end_minute'] == '00' ? ' selected="selected"' : '') ?>>00</option>
							<option<?php print ($values['end_minute'] == '15' ? ' selected="selected"' : '') ?>>15</option>
							<option<?php print ($values['end_minute'] == '30' ? ' selected="selected"' : '') ?>>30</option>
							<option<?php print ($values['end_minute'] == '45' ? ' selected="selected"' : '') ?>>45</option>
						</select>
						<select id="end_ampm" name="end_ampm">
							<option value="">--</option>
							<option<?php print ($values['end_ampm'] == 'am' ? ' selected="selected"' : '') ?>>am</option>
							<option<?php print ($values['end_ampm'] == 'pm' ? ' selected="selected"' : '') ?>>pm</option>
						</select>
		...
		<fieldset class="action">
			...
			<a class="button left" href="<?php print $this->createXhtmlValidUrl('view', false, 'Events'); ?>" title="Click to Cancel Editing This Event"><span>Cancel</span></a>
		</fieldset>
	</form>
