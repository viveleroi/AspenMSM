	...
	<div id="editor_<?php print $next_id ?>_form" class="editable">
		...
		<ol>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-subtitle.htm" title="Sub-Title">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-show_subtitle.htm" title="Show Sub-Title">Help</a>
			</li>
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-placement_group.htm" title="Placement Group">Help</a>
			</li>
			...
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-show_recurring.htm" title="Hide Expired">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-show_nonrecurring.htm" title="Hide Expired">Help</a>
			</li>
			...
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-show_recent_events.htm" title="Show Recent Events">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-hide_expired.htm" title="Hide Expired">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-link_to_full_page.htm" title="Link to Full Page">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Events_Admin') ?>/help/section-events-show_description.htm" title="Show Description">Help</a>
			</li>
			<li class="auto">
