	...
	<div id="editor_<?php print $next_id ?>_form" class="editable">
		...
		<ol>
			...
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl() ?>/help/section-image.htm" title="Image">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl() ?>/help/section-image_alt.htm" title="Image Alt">Help</a>
			</li>
			<li class="thumbs">
				<span class="false-label">Current Image:</span>
				<img src="<?php print router()->getUploadsUrl() .DS. $section['content']['image_thumbname'];?>" />
				<a class="help" href="<?php print router()->moduleUrl() ?>/help/section-current_image.htm" title="Current Image">Help</a>
			</li>
		</ol>
