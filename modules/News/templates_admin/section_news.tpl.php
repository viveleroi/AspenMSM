	...
	<div id="editor_<?php print $next_id ?>_form" class="editable">
		...
		<ol>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('News_Admin') ?>/help/section-news-subtitle.htm" title="Sub-Title">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('News_Admin') ?>/help/section-news-show_subtitle.htm" title="Show Sub-Title">Help</a>
			</li>
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('News_Admin') ?>/help/section-news-placement_group.htm" title="Placement Group">Help</a>
			</li>
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('News_Admin') ?>/help/section-news-show_recent_news.htm" title="Show Recent News">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('News_Admin') ?>/help/section-news-link_to_full_page.htm" title="Link to Full Page">Help</a>
			</li>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('News_Admin') ?>/help/section-news-show_description.htm" title="Show Description">Help</a>
			</li>
			<li class="auto">
