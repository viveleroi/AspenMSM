			...
			<fieldset>
				<ol>
					<li>
						...
						<a class="help" href="<?php print router()->getModuleUrl() ?>/help/news-article_title.htm" title="Article Title">Help</a>
					</li>
					<li>
						...
						<a class="help" href="<?php print router()->getModuleUrl() ?>/help/news-article_title.htm" title="Article Date">Help</a>
					</li>
				</ol>
				<ol>
					<li>
						...
						<a class="help" href="<?php print router()->getModuleUrl() ?>/help/news-summary.htm" title="Summary">Help</a>
					</li>
					<li class="tmce">
				...
				<ol>
					<li>
						...
						<a class="help" href="<?php print router()->getModuleUrl() ?>/help/news-pdf_attachment.htm" title="PDF Attachment">Help</a>
					</li>
				</ol>
			</fieldset>
		</div>
