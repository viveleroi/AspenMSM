	...
	<div id="editor_<?php print $next_id ?>_form" class="editable">
		...
		<ol>
			<li>
				...
				<a class="help" href="<?php print router()->moduleUrl('Forms_Admin') ?>/help/section-form-subtitle.htm" title="Sub-Title">Help</a>
			</li>
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('Forms_Admin') ?>/help/section-form-show_subtitle.htm" title="Show Sub-Title">Help</a>
			</li>
			<li class="auto">
				...
				<a class="help" href="<?php print router()->moduleUrl('Forms_Admin') ?>/help/section-form-placement_group.htm" title="Placement Group">Help</a>
			</li>
			<li class="auto">
