			...
			<fieldset>
				<ol>
					<li>
						...
						<a class="help" href="<?php print $this->APP->router->getModuleUrl() ?>/help/formbuilder-settings-title.htm" title="Title">Help</a>
					</li>
					<li>
						<label for="email">E-mail Form to:</label>
						<input id="email" name="email" type="text" value="<?php print $values['email']; ?>" />
						<a class="help" href="<?php print $this->APP->router->getModuleUrl() ?>/help/formbuilder-settings-email.htm" title="Email Form To">Help</a>
					</li>
					<li>
						...
						<a class="help" href="<?php print $this->APP->router->getModuleUrl() ?>/help/formbuilder-settings-email_user.htm" title="E-mail User">Help</a>
					</li>
					<li>
						...
						<a class="help" href="<?php print $this->APP->router->getModuleUrl() ?>/help/formbuilder-settings-email_message.htm" title="E-mail Message">Help</a>
					</li>
					<li>
						...
						<a class="help" href="<?php print $this->APP->router->getModuleUrl() ?>/help/formbuilder-settings-include_data.htm" title="Include Form Data">Help</a>
					</li>
					<li>
						...
						<a class="help" href="<?php print $this->APP->router->getModuleUrl() ?>/help/formbuilder-settings-return.htm" title="Return Page:">Help</a>
					</li>
				</ol>
			</fieldset>
		</div>
