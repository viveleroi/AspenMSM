  ...
  $.fn.cluetip = function(js, options) {
    ...
    return this.each(function(index) {
      ...
      if (!$('#cluetip').length) {
        ...
        $cluetipTitle = $('<h4 id="cluetip-title"><span class="tip-title"></span></h4>');        
...
// get dimensions and options for cluetip and prepare it to be shown
    var cluetipShow = function(bpY) {
      ...
      tipTitle ? $cluetipTitle.show().html('<span>'+tipTitle+'</span>') : (opts.showTitle) ? $cluetipTitle.show().html('<span>&nbsp;</span>') : $cluetipTitle.hide();
      if (opts.sticky) {
        var $closeLink = $('<a id="cluetip-close" class="close" href="#">' + opts.closeText + '</a>');
      ...
      if ( (/click|toggle/).test(opts.activation) ) {
        $this.click(function(event) {
          if ($cluetip.is(':hidden') || !$this.is('.cluetip-clicked')) {
            activate(event);
            $('.cluetip-clicked').removeClass(opts.clickClass);
            $('.cluetip-clicked').removeClass('cluetip-clicked');
 ...
 */
  ...
  $.fn.cluetip.defaults = {  // set up default options
    ...
    cluetipClass:     'help',// class added to outermost clueTip div in the form of 'cluetip-' + clueTipClass.
    hoverClass:       '',       // class applied to the invoking element onmouseover and removed onmouseout
    clickClass:       'live-help',       // class applied to the invoking element click and removed when clicked
